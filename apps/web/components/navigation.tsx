  ...
  return (
    <aside className="border-b border-slate-200 bg-white px-5 py-5 lg:min-h-screen lg:w-64 lg:border-b-0 lg:border-r lg:px-6 lg:py-8">
      ...
      <div className="mt-8 hidden rounded-2xl bg-slate-50 p-4 lg:block">
        <p className="text-xs font-semibold uppercase tracking-widest text-indigo-600">Phase 3</p>
        <p className="mt-2 text-sm leading-6 text-slate-600">Resume Intelligence 与 Job Intelligence 已接入。</p>
      </div>
    </aside>
  );
}
