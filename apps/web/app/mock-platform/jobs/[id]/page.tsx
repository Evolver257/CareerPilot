  ...
  return (
    <div className="mx-auto max-w-4xl space-y-6">
      ...
      <article className="panel border-indigo-200">
        ...
        <button className="mt-5 rounded-xl bg-indigo-600 px-5 py-3 text-sm font-medium text-white hover:bg-indigo-700" data-mock-action="apply" onClick={() => setApplied(true)} type="button">{applied ? "已投递" : "立即投递"}</button>
      </article>
    </div>
  );
}
